// Package imx provides primitives to interact with the openapi HTTP API.
//
...
// Defines values for ImxLoginPostParamsAppId.
const (
	Admin         ImxLoginPostParamsAppId = "admin"
	App           ImxLoginPostParamsAppId = "App"
	Opsupport     ImxLoginPostParamsAppId = "opsupport"
	Passwordreset ImxLoginPostParamsAppId = "passwordreset"
	Portal        ImxLoginPostParamsAppId = "portal"
	Register      ImxLoginPostParamsAppId = "register"
	Scim          ImxLoginPostParamsAppId = "scim"
)
...
// ImxLoginPostJSONBody defines parameters for ImxLoginPost.
type ImxLoginPostJSONBody map[string]string

// ImxLoginPostParams defines parameters for ImxLoginPost.
type ImxLoginPostParams struct {
	// Noxsrf Disable XSRF protection for the session
	Noxsrf *bool `form:"noxsrf,omitempty" json:"noxsrf,omitempty"`
}

// ImxLoginPostParamsAppId defines parameters for ImxLoginPost.
type ImxLoginPostParamsAppId string

// ImxLoginPostJSONRequestBody defines body for ImxLoginPost for application/json ContentType.
type ImxLoginPostJSONRequestBody ImxLoginPostJSONBody
...
type ClientInterface interface {
	// ImxLoginPostWithBody request with any body
	ImxLoginPostWithBody(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	ImxLoginPost(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, body ImxLoginPostJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) ImxLoginPostWithBody(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewImxLoginPostRequestWithBody(c.Server, appId, params, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ImxLoginPost(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, body ImxLoginPostJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewImxLoginPostRequest(c.Server, appId, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewImxLoginPostRequest calls the generic ImxLoginPost builder with application/json body
func NewImxLoginPostRequest(server string, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, body ImxLoginPostJSONRequestBody) (*http.Request, error) {
	...
	return NewImxLoginPostRequestWithBody(server, appId, params, "application/json", bodyReader)
}

// NewImxLoginPostRequestWithBody generates requests for ImxLoginPost with any type of body
func NewImxLoginPostRequestWithBody(server string, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/imx/login/%s", pathParam0)
	if operationPath[0] == '/' {
...
type ClientWithResponsesInterface interface {
	// ImxLoginPostWithBodyWithResponse request with any body
	ImxLoginPostWithBodyWithResponse(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ImxLoginPostResponse, error)

	ImxLoginPostWithResponse(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, body ImxLoginPostJSONRequestBody, reqEditors ...RequestEditorFn) (*ImxLoginPostResponse, error)
}

type ImxLoginPostResponse struct {
	Body         []byte
	HTTPResponse *http.Response
}

// Status returns HTTPResponse.Status
func (r ImxLoginPostResponse) Status() string {
...
func (r ImxLoginPostResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
// ImxLoginPostWithBodyWithResponse request with arbitrary body returning *ImxLoginPostResponse
func (c *ClientWithResponses) ImxLoginPostWithBodyWithResponse(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ImxLoginPostResponse, error) {
	rsp, err := c.ImxLoginPostWithBody(ctx, appId, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseImxLoginPostResponse(rsp)
}

func (c *ClientWithResponses) ImxLoginPostWithResponse(ctx context.Context, appId ImxLoginPostParamsAppId, params *ImxLoginPostParams, body ImxLoginPostJSONRequestBody, reqEditors ...RequestEditorFn) (*ImxLoginPostResponse, error) {
	rsp, err := c.ImxLoginPost(ctx, appId, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseImxLoginPostResponse(rsp)
...
// ParseImxLoginPostResponse parses an HTTP response from a ImxLoginPostWithResponse call
func ParseImxLoginPostResponse(rsp *http.Response) (*ImxLoginPostResponse, error) {
